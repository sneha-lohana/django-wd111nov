...
# BASE_DIR=C:\Sneha\Django\WD111Nov\onlinesale
...
SECRET_KEY = '_mhlb)o2)!@=fbq8*gjvqwqdfgsdjhgdsjk+8nln309fjqp9*i5iawb6i)f$9c'
...
INSTALLED_APPS = [
    ...
    'accounts', 'products', 'carts',  'tags', 'search', 'orders', 'billing', 'addresses'
]
